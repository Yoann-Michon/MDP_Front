...
const Footer = () => {
  ...
  const association = [
    ...
    { label: "Boutique", path: "/shop", external: true, url: "https://unjourdepaix.myshopify.com/" },
    { label: "Contact", path: "/contact" },
    { label: "Team", path: "/aboutus" },
  ];
  const utils = [
    { label: "Conditions Générales d'Utilisation", path: "/cgu" },
    { label: "Conditions Générales de Vente", path: "/cgv" },
    { label: "Mentions Légales", path: "/mentionLegal" },
    { label: "Paiements Sécurisés", path: "/paiement" },
  ];
